"""Display brightness proxy; not a calibrated retina. Same adapter as STONKFLY."""
...
def retinal_samples(frame, uv):
    ...
    return (linear @ np.asarray([0.2126, 0.7152, 0.0722], dtype=np.float32)).astype(np.float32)
